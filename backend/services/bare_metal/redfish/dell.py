"""Dell iDRAC BMC vendor plugin."""

from services.bare_metal.redfish.vendor_base import VendorPlugin


class DellPlugin(VendorPlugin):
    """Dell iDRAC-specific Redfish behavior."""
    ...
    def get_nic_mode_attribute_path(self) -> str:
        # Dell uses iDRAC-specific OEM extensions
        return "/redfish/v1/Systems/System.Embedded.1/Bios/Settings"
