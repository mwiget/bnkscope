...
/**
 * Anvil mark for BNK Forge.
 *
 * Source: "anvil" by Lorc (game-icons.net), licensed CC BY 3.0
 * https://game-icons.net/1x1/lorc/anvil.html
 *
 * Recolored to `currentColor` so it inherits the surrounding text color
 * (set via a Tailwind text-* class) and adapts to light/dark themes.
 */
export function ForgeLogo(props: SVGProps<SVGSVGElement>) {
  return (
